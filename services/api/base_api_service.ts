...
api.interceptors.request.use(
  async (config) => {
    ...
    await setItem(
      AUTH_TOKEN_KEY,
      "eyJhbGciOiJIUzUxMiJ9..2HfMsJDdZApsPVqyENNCvwi6pVuNYzZvRXMjhvIRRAJGXNY2LW_363WRzh4Yq7ZtwglrwNNn2NhCCfxKaO3rcQ");
    await setItem(
      REFRESH_TOKEN_KEY,
